...
<nav class="mb-5">
    <div id="shipTabs"
        ...
        <span id="shipTabIndicator"
            class="pointer-events-none absolute top-1 left-1 z-0 h-[34px] rounded-xl bg-pink-50 ring-1 ring-pink-200 shadow-sm
        ...
        <a href="{{ route('admin.shipping.carriers.index') }}"
            class="ship-tab relative z-[1] overflow-hidden px-3 py-2 rounded-xl flex items-center gap-2 text-sm
              ...
              {{ request()->routeIs('admin.shipping.carriers.*') ? 'is-active text-pink-700' : '' }}">
        ...
        <a href="{{ route('admin.shipping.zones.index') }}"
            class="ship-tab relative z-[1] overflow-hidden px-3 py-2 rounded-xl flex items-center gap-2 text-sm
              transition-[color,transform] hover:scale-[1.03]
              {{ request()->routeIs('admin.shipping.zones.*') ? 'is-active text-pink-700' : '' }}">
        ...
        <a href="{{ route('admin.shipping.rates.index') }}"
            class="ship-tab relative z-[1] overflow-hidden px-3 py-2 rounded-xl flex items-center gap-2 text-sm
              transition-[color,transform] hover:scale-[1.03]
              {{ request()->routeIs('admin.shipping.rates.*') ? 'is-active text-pink-700' : '' }}">
