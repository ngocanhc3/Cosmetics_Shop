...
<div>
    ...
    <input name="name" value="{{ old('name', $addr->name ?? '') }}"
        class="mt-1 w-full px-3 py-2 rounded border border-pink-200 outline-none focus:ring-2 focus:ring-brand-300">
</div>
<div>
...
<div class="md:col-span-2">
    ...
    <input name="line1" value="{{ old('line1', $addr->line1 ?? '') }}"
        class="mt-1 w-full px-3 py-2 rounded border border-pink-200 outline-none focus:ring-2 focus:ring-brand-300" placeholder="Số nhà, đường...">
</div>
<div class="md:col-span-2">
