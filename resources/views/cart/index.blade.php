@extends('layouts.app')
@section('title','Giỏ hàng | Cosme House')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-4">
            <div class="bg-white border border-pink-100 rounded-2xl p-4 space-y-4">
                ...
                <a id="btnCheckout" href="{{ route('checkout.index') }}"
...
<script>
    // Endpoints
    window.R = {
        cartJson: @json(route('cart.json')),
        cartBase: @json(url('/cart')), // PATCH/DELETE: `${cartBase}/${key}`
        couponApply: @json(route('coupon.apply')),
        couponRemove: @json(route('coupon.remove')),
        couponMine: @json(route('coupon.mine')),
    };
