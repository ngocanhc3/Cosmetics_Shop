    ...
    <style>
        ...
        @layer theme {
            ...
            :host {
                ...
                --color-pink-50: oklch(.97 .014 254.604);
                --color-pink-100: oklch(.932 .032 255.585);
                --color-pink-200: oklch(.882 .059 254.128);
                --color-pink-300: oklch(.809 .105 251.813);
                --color-pink-400: oklch(.707 .165 254.624);
                --color-pink-500: oklch(.623 .214 259.815);
                --color-pink-600: oklch(.546 .245 262.881);
                --color-pink-700: oklch(.488 .243 264.376);
                --color-pink-800: oklch(.424 .199 265.638);
                --color-pink-900: oklch(.379 .146 265.522);
                --color-pink-950: oklch(.282 .091 267.935);
                ...
                --color-pink-50: oklch(.969 .015 12.422);
                --color-pink-100: oklch(.941 .03 12.58);
                --color-pink-200: oklch(.892 .058 10.001);
                --color-pink-300: oklch(.81 .117 11.638);
                --color-pink-400: oklch(.712 .194 13.428);
                --color-pink-500: oklch(.645 .246 16.439);
                --color-pink-600: oklch(.586 .253 17.585);
                --color-pink-700: oklch(.514 .222 16.935);
                --color-pink-800: oklch(.455 .188 13.697);
                --color-pink-900: oklch(.41 .159 10.272);
                --color-pink-950: oklch(.271 .105 12.094);
